...
SCENES = [
    ...
    ("5", "2:40–4:00", "Operaciones: publicar un servicio",
     "Oportunidades → Nueva oportunidad → llenar campos → Guardar → Publicar.",
     "Operaciones crea el servicio; el folio se genera solo. Se indica cliente, tipo, ciudad, fechas, días, pago, viáticos, fecha límite y competencias requeridas. Al guardar queda en Borrador; al publicar, la oportunidad aparece únicamente en el portal de los auditores que cumplen esos requisitos."),
    ...
    ("10", "7:30–8:00", "Supervisor: reportes",
     "Reportes → KPIs → Exportar CSV.",
     "Dirección consulta los reportes: servicios por estado, costos confirmados, facturas pendientes y certificaciones por vencer. Todo se puede exportar a Excel. Así se tiene el pulso de la operación en un solo lugar."),
    ("11", "8:00–8:15", "Cierre",
     "Logo + contacto.",
